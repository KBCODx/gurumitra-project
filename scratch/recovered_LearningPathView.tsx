          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
              {activeLearningPlan.selectedSubjects.map(sub => {
                const subSnapshot = activeLearningPlan.performanceSnapshot?.subjectScores?.[sub];
                  ...
                  >
                    ...
                    <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      {chaptersInPlan.map(chName => {
                        ...
                        const chScore = activeLearningPlan.performanceSnapshot?.chapterScores?.[chName];
